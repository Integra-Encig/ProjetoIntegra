...
class Sapatas(Footings):
    ...
    def __init__(self, object):
        ...
        shape = create_shape(settings, object)

   
        self.set_identificador(object.id())
        self.set_shape_area(shape)
        self.set_lean_volume(shape)
        self.set_volume(shape)
        self.set_waterproofing(shape)
